...
const agencies = [
  {
    ...
    featured: true,
    verified: true,
    specialties: ["Luxury Travel", "Adventure Tours", "Family Vacations"],
  },
  {
    id: 2,
    name: "AsiaEscapes",
    ...
    featured: true,
    verified: true,
    specialties: ["Asian Destinations", "Cultural Tours", "Beach Getaways"],
  },
  {
    id: 3,
    name: "EuroVentures",
    ...
    featured: false,
    verified: true,
    specialties: ["European Tours", "Historical Sites", "Food & Wine"],
  },
  {
    id: 4,
    ...
    featured: false,
    verified: true,
    specialties: ["Australia & NZ", "Island Hopping", "Wildlife Tours"],
  },
]
